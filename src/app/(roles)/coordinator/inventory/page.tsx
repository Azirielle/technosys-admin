...
export default function InventoryLedgerPage() {
  ...
  return (
    <div className="flex flex-col h-full w-full max-w-full space-y-5">
      {/* Header Banner */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between bg-white p-5 rounded-2xl border border-zinc-200/80 shadow-xs gap-4">
        <div>
          <div className="flex items-center gap-2 mb-1">
            <h1 className="text-xl font-bold tracking-tight text-zinc-900 leading-none">Tool Inventory & Custody Vault</h1>
            <span className="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-semibold bg-emerald-50 text-emerald-700 border border-emerald-200">
              Active Lifecycle
            </span>
          </div>
          <p className="text-xs text-zinc-500">Track equipment availability, issue tools to crews, and audit returns with condition verification.</p>
        </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3.5">
        <div className="bg-white p-4 rounded-xl border border-zinc-200/80 shadow-xs flex items-center gap-3">
          <div className="w-10 h-10 rounded-lg bg-emerald-50 text-emerald-600 flex items-center justify-center">
            <Package className="w-5 h-5" />
          </div>
          <div>
            <p className="text-[11px] font-medium text-zinc-500">Total Tool Assets</p>
            <p className="text-lg font-bold text-zinc-900">{totalAssets} <span className="text-xs font-normal text-zinc-400">units</span></p>
          </div>
        </div>
      ...
      <div className="bg-white rounded-2xl shadow-xs border border-zinc-200/80 overflow-hidden flex flex-col flex-1">
        {/* Top View Mode Tabs */}
        <div className="px-5 pt-4 pb-0 border-b border-zinc-200/80 bg-zinc-50/60 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <button
              onClick={() => {
        ...
        <div className="p-4 border-b border-zinc-200 bg-white flex flex-wrap gap-3 items-center justify-between">
          <div className="relative w-full sm:w-80">
            ...
            <input
              ...
              className="block w-full pl-9 pr-3 py-1.5 border border-zinc-300 rounded-xl text-xs bg-zinc-50/50 placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 focus:bg-white transition-all"
            />
          </div>
      ...
      {isToolModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-zinc-900/60 backdrop-blur-xs p-4">
          <div className="bg-white rounded-2xl shadow-xl max-w-lg w-full overflow-hidden border border-zinc-200">
            ...
            <form onSubmit={handleToolFormSubmit} className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="col-span-2">
                  <label className="block text-xs font-semibold text-zinc-700 mb-1">Equipment Name *</label>
                  <input
                    type="text"
                    name="name"
                    required
                ...
                <div>
                  <label className="block text-xs font-semibold text-zinc-700 mb-1">Total Stock *</label>
                  <input
                    type="number"
                    name="total_stock"
                    min="0"
                ...
                <div>
                  <label className="block text-xs font-semibold text-zinc-700 mb-1">Available in Warehouse *</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-xs font-semibold text-zinc-700 mb-1">Unit Cost (₱)</label>
                  <input
                    type="number"
                    name="unit_cost"
                    min="0"
                ...
                <div className="col-span-2">
                  <label className="block text-xs font-semibold text-zinc-700 mb-1">Description / Spec Notes</label>
                  <textarea
                    name="description"
                    rows={2}
                ...
                <div className="col-span-2">
                  <label className="block text-xs font-semibold text-zinc-700 mb-1">Photo Upload</label>
                  <input
                    type="file"
                    name="image"
                    accept="image/*"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-zinc-900/60 backdrop-blur-xs p-4">
          <div className="bg-white rounded-2xl shadow-xl max-w-md w-full overflow-hidden border border-zinc-200">
            ...
            <form onSubmit={handleCheckoutSubmit} className="p-6 space-y-4">
              ...
              <div>
                <label className="block text-xs font-semibold text-zinc-700 mb-1">Assign to Field Crew *</label>
                <select
                  required
      ...
      {isReturnModalOpen && returningAssignment && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-zinc-900/60 backdrop-blur-xs p-4">
          <div className="bg-white rounded-2xl shadow-xl max-w-md w-full overflow-hidden border border-zinc-200">
            <div className="px-6 py-4 border-b border-zinc-200 flex items-center justify-between">
              <div>
                <h3 className="text-base font-bold text-zinc-900">Equipment Return & Condition Audit</h3>
            ...
            <form onSubmit={handleReturnSubmit} className="p-6 space-y-4">
              ...
              <div>
                <label className="block text-xs font-semibold text-zinc-700 mb-1">Condition & Inspection Notes</label>
                <textarea
                  rows={2}
                  value={returnNotes}
      ...
      {selectedAssignment && (
        ...
        >
          ...
          >
            <div className="px-6 py-4 border-b border-zinc-200 flex items-center justify-between">
              <div>
                <h3 className="text-base font-bold text-zinc-900">Custody Record Details</h3>
